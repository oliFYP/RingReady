...
import { FaUser, FaEnvelope, FaBoxing, FaTrophy, FaWeight } from 'react-icons/fa';
            ...
            {isEditing ? (
              <form onSubmit={formik.handleSubmit} className="space-y-6">
                ...
                {userProfile?.role === 'boxer' && (
                  <div>
                    <h2 className="text-xl font-semibold mb-4">Boxing Information</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                      <div>
                        ...
                        >
                          ...
                          <option value="bantamweight">Bantamweight (118 lbs)</option>
                          <option value="featherweight">Featherweight (126 lbs)</option>
                          <option value="lightweight">Lightweight (135 lbs)</option>
                          <option value="welterweight">Welterweight (147 lbs)</option>
                          <option value="middleweight">Middleweight (160 lbs)</option>
                          <option value="lightheavyweight">Light Heavyweight (175 lbs)</option>
                      ...
                      <div>
                        <label htmlFor="experience" className="block text-gray-700 font-medium mb-2">
                          <FaBoxing className="inline-block mr-2 text-primary-600" />
                          Experience Level
                        </label>
                        <select
                          id="experience"
                          name="experience"
                          className={`input ${
                            formik.touched.experience && formik.errors.experience ? 'border-red-500' : ''
                          }`}
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <div>
                        <label htmlFor="wins" className="block text-gray-700 font-medium mb-2">
                        ...
                        <input
                          ...
                          min="0"
                          className={`input ${
                            formik.touched.wins && formik.errors.wins ? 'border-red-500' : ''
                          }`}
                      ...
                      <div>
                        <label htmlFor="losses" className="block text-gray-700 font-medium mb-2">
                          Losses
                        </label>
                        <input
                          id="losses"
                          ...
                          min="0"
                          className={`input ${
                            formik.touched.losses && formik.errors.losses ? 'border-red-500' : ''
                          }`}
                      ...
                      <div>
                        <label htmlFor="draws" className="block text-gray-700 font-medium mb-2">
                          Draws
                        </label>
                        <input
                          id="draws"
                          ...
                          min="0"
                          className={`input ${
                            formik.touched.draws && formik.errors.draws ? 'border-red-500' : ''
                          }`}
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-1 md:col-span-2">
                      ...
                      <p className="text-lg">{userProfile?.bio || 'No bio provided'}</p>
                    </div>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                      <div className="space-y-1">
                        ...
                        <p className="text-lg capitalize">{userProfile?.weight || 'Not set'}</p>
                      </div>
                      
                      <div className="space-y-1">
                        <p className="text-sm font-medium text-gray-500">Experience Level</p>
                        <p className="text-lg capitalize">{userProfile?.experience || 'Not set'}</p>
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-100 p-6 rounded-lg">
                      ...
                      <div className="flex items-center justify-center space-x-8">
                        <div className="text-center">
                          ...
                          <p className="text-3xl font-bold text-green-600">{userProfile?.wins || 0}</p>
                        </div>
                        
                        <div className="text-center">
                          <p className="text-sm font-medium text-gray-500">Losses</p>
                          <p className="text-3xl font-bold text-red-600">{userProfile?.losses || 0}</p>
                        </div>
                        
                        <div className="text-center">
                          <p className="text-sm font-medium text-gray-500">Draws</p>
                          <p className="text-3xl font-bold text-blue-600">{userProfile?.draws || 0}</p>
                        </div>
                      </div>
                    </div>
                  </div>
