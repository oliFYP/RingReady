...
function EventDetails() {
      ...
      try {
        ...
        if (eventSnapshot.exists()) {
          ...
          if (
            currentUser &&
            eventData.attendees &&
            eventData.attendees.includes(currentUser.uid)
          ) {
          ...
          if (
            ...
            eventData.boxers &&
            eventData.boxers.includes(currentUser.uid)
          ) {
  ...
  const mockEvent = {
    ...
    description:
      "A showcase of the best amateur boxing talent in the region. This event features multiple weight divisions and competitors of all skill levels. Come watch the future stars of boxing as they compete for regional titles and recognition.",
              ...
              >
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-4 mb-6 text-lg">
                  <div className="flex items-center">
                    ...
                    <span>
                      {format(displayEvent.date, "EEEE, MMMM d, yyyy")}
                    </span>
                  </div>
                ...
                <div className="flex flex-wrap gap-4">
                  <span className="inline-flex items-center bg-primary-600 text-white px-4 py-1 rounded-full text-lg font-medium">
                    <FaTicketAlt className="mr-2" />${displayEvent.ticketPrice}
                  </span>

                  <span className="inline-flex items-center bg-gray-700 text-white px-4 py-1 rounded-full text-lg">
                    <FaUsers className="mr-2" />
                    {displayEvent.remaining}/{displayEvent.capacity} Seats
                    Available
                  </span>
                </div>
              </motion.div>
                    ...
                    <div className="border-l-4 border-primary-500 pl-4">
                      <div className="mb-4">
                        <h3 className="font-semibold text-xl">
                          {format(displayEvent.date, "h:mm a")} - Doors Open
                        </h3>
                        <p className="text-gray-600">
                          Attendees can enter the venue
                        </p>
                      </div>
                      <div className="mb-4">
                        <h3 className="font-semibold text-xl">
                          {format(
                            new Date(
                              displayEvent.date.getTime() + 60 * 60 * 1000
                            ),
                            "h:mm a"
                          )}{" "}
                          - First Bout
                      ...
                      <div>
                        <h3 className="font-semibold text-xl">
                          {format(
                            new Date(
                              displayEvent.date.getTime() + 3 * 60 * 60 * 1000
                            ),
                            "h:mm a"
                          )}{" "}
                          - Main Event
                  ...
                  <div>
                    ...
                    <div className="bg-gray-100 p-4 rounded-lg">
                      ...
                      <p className="text-gray-700 mb-4">
                        The venue is equipped with state-of-the-art boxing
                        facilities and comfortable seating for all attendees.
                      </p>
                        ...
                        <>
                          ...
                          <div className="mb-6">
                            ...
                            <div className="flex justify-between font-bold text-lg mt-2 pt-2 border-t">
                              <span>Total:</span>
                              <span>
                                ${displayEvent.ticketPrice * ticketCount}
                              </span>
                            </div>
                          </div>
                          ...
                          <button
                            ...
                            disabled={
                              purchaseLoading || displayEvent.remaining < 1
                            }
                      ...
                      <div className="card p-6">
                        ...
                        {boxerJoinSuccess ? (
                          <div className="bg-green-100 text-green-700 p-4 rounded-lg mb-4">
                            ...
                            <p>
                              You've successfully applied to participate in this
                              event as a boxer.
                            </p>
                          </div>
                        ) : (
                          <>
                            <p className="text-gray-700 mb-4">
                              Interested in competing at this event? Submit your
                              application to join as a boxer.
                            </p>
